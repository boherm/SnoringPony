...
#define ApplicationName 'SnoringPony'
#define ApplicationVersion GetStringFileInfo('Binaries/CI/App/SnoringPony.exe',"ProductVersion")

[Setup]
AppName={#ApplicationName}
AppId={#ApplicationName}
AppVersion={#ApplicationVersion}
AppPublisher=Boris Hermans
AppPublisherURL=https://boherm.dev
