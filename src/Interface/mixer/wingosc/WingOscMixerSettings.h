...
class WingOscMixerSettings : public MixerSettings
{
public:
    WingOscMixerSettings();
    ~WingOscMixerSettings() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(WingOscMixerSettings)
};
